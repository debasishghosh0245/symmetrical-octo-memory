public class ConstructBinarySearchTreePreorderTraversal_1008{
	...
	public static TreeNode constructBSTII(int[] preorder,int min,int max) {
		...
		root.left=constructBSTII(preorder,min,root.val);
		root.right=constructBSTII(preorder,root.val,max);
		return root;
    }
	...
	public static void main(String[] args){
		...
		TreeNode node=constructBSTII(preorder,Integer.MIN_VALUE,Integer.MAX_VALUE);
		display(node);
	}
